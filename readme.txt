...
* Added further options when initiating the Sentry client in the WordPress settings page, such as environment, 	server hostname and contexts.
* Added shortcode functions for Context options to send different data to Sentry.
* Added a notice reminder for the admin if WP_DEBUG is enabled and should be disabled in production environment.
* Added Sentry documentation extract of usage & examples, for reference.
